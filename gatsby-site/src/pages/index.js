...
const SvgPattern = ({ id, size = 30, color, children, style, ...props }) => (
  <svg
    {...props}
    style={{
      width: "100%",
...
const SvgPattern2 = props => (
  <SvgPattern id="pattern2" {...props}>
    <path fillRule="evenodd" d="M8 4l4 2-4 2-2 4-2-4-4-2 4-2 2-4 2 4z"/>
  </SvgPattern>
);

const SvgPattern3 = props => (
  <SvgPattern id="pattern3" {...props}>
    <path d="M6 18h12V6H6v12zM4 4h16v16H4V4z" fillRule="nonzero"/>
  </SvgPattern>
);
const SvgPattern4 = props => (
  <SvgPattern id="pattern4" size={50} {...props}>
    <path
